...
func NewMaximalPermissionAuthorizer(deepSARClient kcpkubernetesclientset.ClusterInterface, filteredAPIExportESInformer apisv1alpha2informers.FilteredAPIExportEndpointSliceClusterInformer, apiExportInformer apisv1alpha2informers.APIExportClusterInformer) authorizer.Authorizer {
