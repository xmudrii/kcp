...
import (
	...
	apiexportbuiltin "github.com/kcp-dev/kcp/pkg/virtual/filteredapiexport/schemas/builtin"
	"github.com/kcp-dev/kcp/pkg/virtual/framework/dynamic/apidefinition"
	dynamiccontext "github.com/kcp-dev/kcp/pkg/virtual/framework/dynamic/context"
)

func (c *APIReconciler) reconcile(ctx context.Context, filteredSlice *apisv1alpha2.FilteredAPIExportEndpointSlice, apiDomainKey dynamiccontext.APIDomainKey) error {
	...
	for _, pc := range apiExport.Spec.PermissionClaims {
		...
		if pc.Group == apis.GroupName {
			...
			// TODO(xmudrii): THIS WILL NOT WORK WHEN OUT OF TREE!
	...
	if !claimFilteredAPIExportES {
		gvr := apisv1alpha2.SchemeGroupVersion.WithResource("filteredapiexportendpointslices")
