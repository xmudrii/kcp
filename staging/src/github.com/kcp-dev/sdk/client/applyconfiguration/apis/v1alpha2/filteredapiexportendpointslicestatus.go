...
type FilteredAPIExportEndpointSliceStatusApplyConfiguration struct {
	...
	APIExportEndpoints []FilteredAPIExportEndpointApplyConfiguration `json:"endpoints,omitempty"`
}
...
func (b *FilteredAPIExportEndpointSliceStatusApplyConfiguration) WithConditions(value v1alpha1.Conditions) *FilteredAPIExportEndpointSliceStatusApplyConfiguration {
	b.Conditions = &value
	return b
}
...
func (b *FilteredAPIExportEndpointSliceStatusApplyConfiguration) WithAPIExportEndpoints(values ...*FilteredAPIExportEndpointApplyConfiguration) *FilteredAPIExportEndpointSliceStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
